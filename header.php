<?php
    ...
    // CONDITION TO CHECK WHETHER A USER IS LOGGED IN
    if (isset($_SESSION['fos-ms_id'])) {
    
        $userid = $_SESSION['fos-ms_id'];
	
    }else{

        header("Location: ./login.php");

        //echo "<script>window.location.href='../modules/login.php'</script>";
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="../public/index-0.html">Analytics</a></li>
                            <li class="active"><a class="nav-link" href="../public/index-2.html">Ecommerce</a></li>
                        </ul>
                    </li>
